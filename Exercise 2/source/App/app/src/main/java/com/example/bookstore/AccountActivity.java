...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GVars.INSTANCE.bookGrabType = "account";
        getJSON("http://undcemcs02.und.edu/~tyler.w.clark/457/2/account_app.php?userID=" + GVars.INSTANCE.uID);
        v = findViewById(R.id.textView13);
        v.setText("Total Spent: $" + GVars.INSTANCE.totalSpent);
    }
            ...
            protected String doInBackground(Void... voids) {
                try {
                    ...
                    while ((json = bufferedReader.readLine()) != null) {
                        if(json.contains(".") && !costFound) {
                            GVars.INSTANCE.totalSpent = json;
                            costFound = true;
                        } else {
                            sb.append(json + "\n");
                        }
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            books.add(new Book(obj.getString("bookISBN"), obj.getString("bookTitle"), (obj.getString("bookQuantity") + " " + obj.getString("bookCost"))));
        }
        BookAdapter bAdapt = new BookAdapter(this, books);
        listView.setAdapter(bAdapt);
    }

    protected void getBook2(View view) {
    ...
    protected boolean getCostBook() {
        ...
        for(int i = 0; i < list.getCount(); i++) {
            v = list.getChildAt(i);
            tv = v.findViewById(R.id.layout_textview5);
